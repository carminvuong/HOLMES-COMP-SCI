...
; The xcor of the right-most burned tree.
; Burned-out embers are very dark red, not true black.
to-report xcorOfRightmostBurnedTree
  report max [pxcor] of patches with
  [     pcolor != green ; not a tree
    and pcolor != black ; not an empty space
  ]
end


; calculates the fraction of the world width that is burned
to-report fraction-of-width-burned-across
  report (xcorOfRightmostBurnedTree - min-pxcor) / world-width
...
195
258
fraction of width burned across
fraction-of-width-burned-across
10
1
11
